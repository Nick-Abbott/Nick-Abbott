...
The work spans semantic retrieval and matching, AI and model experimentation, a Kotlin backend, and a React/TypeScript frontend. I'm building the product end-to-end, including product design, CI/CD, and the engineering infrastructure needed to develop and maintain it.
...
- **Design for the next person changing it.** I optimize for reading, debugging, onboarding, and maintenance as well as writing. Explicit code, clear ownership, and familiar structures matter long after the initial implementation, including when an AI agent helps write it.

## Other things I've built

- **Discord platform:** Around 2019, I built and operated a distributed, service-oriented bot platform that reached roughly 2 million users across 4,000 servers, working with a development team of about five. Building and maintaining independent systems at meaningful scale has been a recurring part of my work.
...
[GitHub](https://github.com/Nick-Abbott) · [LinkedIn](https://www.linkedin.com/in/nicholas-abbott)
